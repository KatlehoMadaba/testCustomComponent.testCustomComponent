...
namespace testCustomComponent.testCustomComponent.Common.Authorization
{
    /// <summary>
    /// testCustomComponent Permission checker
    /// </summary>
    public class testCustomComponentPermissionChecker : ICustomPermissionChecker, ItestCustomComponentPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public testCustomComponentPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
