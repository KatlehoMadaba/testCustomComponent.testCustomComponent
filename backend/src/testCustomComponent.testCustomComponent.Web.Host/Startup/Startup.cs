...
using testCustomComponent.testCustomComponent.Hangfire;
using Shesha;
...
namespace testCustomComponent.testCustomComponent.Web.Host.Startup
{
		...
		public void Configure(IApplicationBuilder app, IBackgroundJobClient backgroundJobs)
		{
			...
			app.UseSwaggerUI(options =>
			{
				...
				options.IndexStream = () => Assembly.GetExecutingAssembly()
					.GetManifestResourceStream("testCustomComponent.testCustomComponent.Web.Host.wwwroot.swagger.ui.index.html");
			}); // URL: /swagger​
