...
using testCustomComponent.testCustomComponent.Tests.DependencyInjection;
using Shesha;
...
namespace testCustomComponent.testCustomComponent.Common.Tests
{
    [DependsOn(
    ...
    public class testCustomComponentCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public testCustomComponentCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
